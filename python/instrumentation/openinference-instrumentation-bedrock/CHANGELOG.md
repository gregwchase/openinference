...
## [0.1.12](https://github.com/gregwchase/openinference/compare/python-openinference-instrumentation-bedrock-v0.1.11...python-openinference-instrumentation-bedrock-v0.1.12) (2024-09-16)


### Features

* add support for meta vendor in openinference-instrumentation-bedrock ([#448](https://github.com/gregwchase/openinference/issues/448)) ([958c385](https://github.com/gregwchase/openinference/commit/958c385b1d8de70698bc2e8368cef36a8e5acf8f))
...
* **bedrock:** add converse api support for bedrock ([#585](https://github.com/gregwchase/openinference/issues/585)) ([b41cab7](https://github.com/gregwchase/openinference/commit/b41cab7ebc1abd730cf26f8e9d7cafce39b59054))
* Capture images tracing converse API ([#753](https://github.com/gregwchase/openinference/issues/753)) ([2a2fe15](https://github.com/gregwchase/openinference/commit/2a2fe15f2b48fe67b14974137c105606072394f3))
...
* Make Bedrock instrumentation read from attributes from context ([#433](https://github.com/gregwchase/openinference/issues/433)) ([69e8277](https://github.com/gregwchase/openinference/commit/69e82773ad4bd6c386831c1b35310996a6967b64))


### Bug Fixes

* Add token counts to bedrock instrumentation ([#270](https://github.com/gregwchase/openinference/issues/270)) ([29b0ac9](https://github.com/gregwchase/openinference/commit/29b0ac9d643c47bb7c6fd62d4cf581dd8157291c))
* **bedrock:** ensure bedrock instrumentation does not break runtime for BedrockEmbeddings model from langchain ([#975](https://github.com/gregwchase/openinference/issues/975)) ([fbb78cd](https://github.com/gregwchase/openinference/commit/fbb78cdf13cc895add911575dc7fb400afafff7d))
* improve bedrock support for non-ascii characters ([#475](https://github.com/gregwchase/openinference/issues/475)) ([e6d1f0a](https://github.com/gregwchase/openinference/commit/e6d1f0acca9ea5d5f00fa10a809a771deb3ff605))
...
* Improve README ([#278](https://github.com/gregwchase/openinference/issues/278)) ([defc847](https://github.com/gregwchase/openinference/commit/defc847bf66dbdf6c38636ee3f88f2b0584fc035))
