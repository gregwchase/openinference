...
## [0.1.5](https://github.com/gregwchase/openinference/compare/python-openinference-instrumentation-litellm-v0.1.4...python-openinference-instrumentation-litellm-v0.1.5) (2024-09-16)


### Features

* **liteLLM:** Added suppress tracing to litellm instrumentation ([#847](https://github.com/gregwchase/openinference/issues/847)) ([bda858a](https://github.com/gregwchase/openinference/commit/bda858ad332a8f9539f9a9edb77d9ede22a08960))
* **liteLLM:** Implemented image support and corresponding tests ([#900](https://github.com/gregwchase/openinference/issues/900)) ([f6d11eb](https://github.com/gregwchase/openinference/commit/f6d11eb602f37770fbdf7ab144c03980c7f90fb7))
* **liteLLM:** instrumentation ([#641](https://github.com/gregwchase/openinference/issues/641)) ([9870286](https://github.com/gregwchase/openinference/commit/9870286e8ea757ca3afa2568bd286231fbaee577))
* **liteLLM:** LiteLLM trace config and context attributes propagation ([#779](https://github.com/gregwchase/openinference/issues/779)) ([d104695](https://github.com/gregwchase/openinference/commit/d104695cdcebea740f98b2e26a2a5bab1a09a55f))
...
* litellm examples ([#681](https://github.com/gregwchase/openinference/issues/681)) ([b6cfe69](https://github.com/gregwchase/openinference/commit/b6cfe6933d840b2344b5c132a9d471d239af1c9d))
